...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  TD(TD_LSFT_INS),  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, MO(_NUMBER),  KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
  KC_LALT, KC_LGUI, KC_LCTL, MO(_NAV), KC_ENT, KC_SPC, MO(_MEDIA), KC_RGUI
),
...
[_MEDIA] = LAYOUT(
  ...
  KC_LALT, KC_LGUI, KC_LCTL, MO(_NAV), KC_ENT, KC_SPC, KC_BSPC, KC_RGUI
),
};
