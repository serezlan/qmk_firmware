...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_GRV_MAC_MEDIA] = ACTION_TAP_DANCE_LAYER_MOVE(KC_GRAVE, MAC_MEDIA),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_f13_ansi(
        ...
        TD(TD_GRV_MAC_MEDIA),   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
