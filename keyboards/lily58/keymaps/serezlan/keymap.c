 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  TD(TD_SHIFT_LOCK),  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_BSPC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
		    KC_LALT, KC_LGUI, KC_LCTL, MO(_LOWER), MO(_RAISE), KC_SPC, KC_RALT, KC_MENU
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
  ...
  XXXXXXX,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    XXXXXXX,                        XXXXXXX,    KC_PGDN,    KC_UP,    KC_PGUP,    XXXXXXX,    _______,
  XXXXXXX,  KC_F5,    KC_F6,   KC_F7,   KC_F8,   XXXXXXX,                       KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT,   KC_END, XXXXXXX,
  XXXXXXX,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  XXXXXXX,   _______, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
...
// --------------------
// Tap dance stuff implementation
// --------------------
